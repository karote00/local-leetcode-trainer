...
const KNOWN_PROBLEMS = {
  easy: [
    ...
    'linked-list-cycle', 'intersection-of-two-linked-lists', 'majority-element',
    'reverse-linked-list', 'contains-duplicate', 'valid-anagram', 'move-zeroes',
    'first-bad-version', 'ransom-note', 'fizz-buzz', 'reverse-string',
  ...
  medium: [
    ...
    'next-permutation', 'search-in-rotated-sorted-array', 'combination-sum',
    'permutations', 'rotate-image', 'group-anagrams', 'maximum-subarray',
    'spiral-matrix', 'jump-game', 'merge-intervals', 'unique-paths',
    'minimum-path-sum', 'set-matrix-zeroes', 'search-a-2d-matrix', 'sort-colors'
  ],
  hard: [
    'median-of-two-sorted-arrays', 'regular-expression-matching', 'merge-k-sorted-lists',
    'reverse-nodes-in-k-group', 'longest-valid-parentheses', 'sudoku-solver',
    'trapping-rain-water', 'wildcard-matching', 'jump-game-ii', 'n-queens',
    'spiral-matrix-ii', 'text-justification', 'edit-distance', 'minimum-window-substring',
    'largest-rectangle-in-histogram', 'maximal-rectangle', 'binary-tree-maximum-path-sum',
    'word-ladder', 'longest-consecutive-sequence', 'word-break-ii', 'lru-cache'
  ]
};
